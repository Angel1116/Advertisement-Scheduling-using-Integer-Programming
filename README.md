...
After running, it would output the schedule in Excel.
...
After running, it would output the schedule in Excel and a bar chart about Jaccard similarity as follows:
